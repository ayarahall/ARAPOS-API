// FILE: Ayapos.Api/Tenancy/BranchMiddleware.cs

using Ayapos.Api.Data;
using Ayapos.Api.Tenancy.Filters;
using Microsoft.EntityFrameworkCore;

namespace Ayapos.Api.Tenancy;
...
public sealed class BranchMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context, ITenantContext tenantCtx, AyaposDbContext db)
    {
