...
public partial class AyaposDbContext : DbContext
{
    public AyaposDbContext(DbContextOptions<AyaposDbContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<BranchUserAssignment> BranchUserAssignments { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasIndex(e => new { e.TenantId, e.BranchId, e.StartAt }, "IX_Appointments_Tenant_Branch_StartAt");
        ...
        modelBuilder.Entity<BranchUserAssignment>(entity =>
        {
            ...
            entity.ToTable("BranchUserAssignments");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.BranchUserAssignments)
        ...
        modelBuilder.Entity<BranchSetting>(entity =>
        {
            ...
            entity.Property(e => e.CompanyAddress).HasMaxLength(220);
            entity.Property(e => e.CompanyLogoUrl).HasMaxLength(500);
            entity.Property(e => e.CompanyName).HasMaxLength(160);
            entity.Property(e => e.CompanyPhone).HasMaxLength(40);
            entity.Property(e => e.CompanyTaxNumber).HasMaxLength(80);
            ...
            entity.Property(e => e.ReceiptHeaderLine1).HasMaxLength(120);
            entity.Property(e => e.ReceiptHeaderLine2).HasMaxLength(120);
            entity.Property(e => e.ReceiptFooterNote).HasMaxLength(220);
            entity.Property(e => e.ShowBranchNameOnReceipt).HasDefaultValue(true);
            entity.Property(e => e.ShowCustomerNameOnReceipt).HasDefaultValue(true);
        ...
        modelBuilder.Entity<Staff>(entity =>
        {
            ...
            entity.Property(e => e.FullName).HasMaxLength(120);
            entity.Property(e => e.HireDate).HasPrecision(0);
            entity.Property(e => e.IsActive).HasDefaultValue(true);
            entity.Property(e => e.IsBookableForAppointments).HasDefaultValue(false);
            entity.Property(e => e.JobTitle).HasMaxLength(40);
            entity.Property(e => e.Notes).HasMaxLength(500);
            entity.Property(e => e.PhotoUrl).HasMaxLength(260);
            entity.Property(e => e.Phone).HasMaxLength(30);
            entity.Property(e => e.SalaryType)
                .HasMaxLength(20)
                .HasDefaultValue("monthly");
            entity.Property(e => e.TrackAttendance).HasDefaultValue(true);
            entity.Property(e => e.WeeklyOffDays).HasMaxLength(40);
            entity.Property(e => e.AppointmentColor).HasMaxLength(20);

            entity.HasIndex(e => new { e.TenantId, e.BranchId, e.IsActive }, "IX_Staff_Tenant_Branch_Active");
            ...
            entity.HasOne(d => d.LinkedUser).WithMany(p => p.LinkedStaffMembers)
        ...
        {
            entity.HasIndex(e => new { e.TenantId, e.BranchId, e.AttendanceDate }, "IX_StaffAttendances_Branch_Date");
            ...
            entity.HasOne(d => d.Branch).WithMany(p => p.StaffAttendances)
                .HasPrincipalKey(p => new { p.TenantId, p.Id })
                .HasForeignKey(d => new { d.TenantId, d.BranchId })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<StaffDocument>(entity =>
        {
            ...
            entity.Property(e => e.FileUrl).HasMaxLength(260);
            entity.Property(e => e.Title).HasMaxLength(120);

            entity.HasOne(d => d.Branch).WithMany(p => p.StaffDocuments)
                .HasPrincipalKey(p => new { p.TenantId, p.Id })
                .HasForeignKey(d => new { d.TenantId, d.BranchId })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_StaffDocuments_Branches_Tenant");

            entity.HasOne(d => d.Staff).WithMany(p => p.Documents)
                .HasForeignKey(d => d.StaffId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<StaffLeave>(entity =>
        {
            ...
            entity.HasOne(d => d.Branch).WithMany(p => p.StaffLeaves)
                .HasPrincipalKey(p => new { p.TenantId, p.Id })
                .HasForeignKey(d => new { d.TenantId, d.BranchId })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_StaffLeaves_Branches_Tenant");

            entity.HasOne(d => d.Staff).WithMany(p => p.Leaves)
                .HasForeignKey(d => d.StaffId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<StaffShift>(entity =>
        {
            ...
            entity.Property(e => e.WeeklyPattern).HasMaxLength(40);
